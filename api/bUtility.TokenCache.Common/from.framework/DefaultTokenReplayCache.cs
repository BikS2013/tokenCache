...
namespace bUtility.TokenCache
{
    ...
    {
        static readonly int DefaultTokenReplayCacheCapacity = 20000;
        public static readonly TimeSpan DefaultTokenReplayCachePurgeInterval = TimeSpan.FromMinutes(30);

        readonly BoundedCache<SecurityToken> _internalCache;
